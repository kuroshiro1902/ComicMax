...
public class Book {
    ...
    private int id, author_id, publisher_id, amount, sold, star, ratingnums;
    private float price;

    public Book(int id, String name, String img, String language, int author_id, int publisher_id, float price, int amount, int sold, int star, int ratingnums ) {
        this.id = id;
        this.name = name;
        this.img = img;
